...
Scale the interrogation to the size and risk of the work. A full project buildout can take about an hour, a huge feature about 30 minutes, a small add-on about 15 minutes, and a PR-sized change that a human could implement in less than a day should take about 5 minutes with at most two high-leverage questions.


When useful, pressure-test requirements and quality attributes directly: performance, reliability, security, usability, maintainability, observability, scalability, cost, and acceptance criteria.
